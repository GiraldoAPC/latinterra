...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traduccion al espanol de los mensajes de validacion por defecto de
    | Laravel (el framework no trae ninguna, solo ingles) - sin esto,
    | cualquier form que no defina un mensaje custom para una regla muestra
    | el texto en ingles ("The dni has already been taken.", etc.).
    |
    */
    ...
    'password' => [
        ...
        'mixed' => 'El campo :attribute debe tener al menos una mayuscula y una minuscula.',
        'numbers' => 'El campo :attribute debe tener al menos un numero.',
        'symbols' => 'El campo :attribute debe tener al menos un simbolo.',
        'uncompromised' => 'El :attribute proporcionado ha aparecido en una filtracion de datos. Elige otro.',
    ],
    ...
    'uploaded' => 'La subida de :attribute fallo.',
    ...
    */
    ...
    'custom' => [
        'dni' => [
            'unique' => 'Ya existe una cuenta registrada con este numero de documento.',
        ],
        'email' => [
            'unique' => 'Ya existe una cuenta registrada con este correo electronico.',
        ],
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Nombres en espanol para los campos, usados dentro de los mensajes de
    | arriba en vez del nombre tecnico de la columna (ej. "birth_date").
    |
    */
    ...
    'attributes' => [
        ...
        'sctr_status' => 'estado SCTR',
        'sctr_expires_at' => 'fecha de vencimiento SCTR',
